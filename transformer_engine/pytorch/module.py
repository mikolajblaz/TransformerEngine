...
class LayerNormLinear(TransformerEngineBaseModule):
    ...
    def __init__(
        ...
        print(f'LayerNormLinear shift: {self.layer_norm_shift}')
...
class LayerNormMLP(TransformerEngineBaseModule):
    ...
    def __init__(
        ...
        self.layer_norm_shift = layer_norm_shift
        print(f'LayerNormMLP shift: {self.layer_norm_shift}')
...
class LayerNorm(torch.nn.Module):
    ...
    def __init__(
        ...
        self.eps = eps
        self.layer_norm_shift = layer_norm_shift
        print(f'LayerNorm shift: {self.layer_norm_shift}')
        self.weight = Parameter(
            torch.empty(
                hidden_size,
                device=torch.cuda.current_device(),
    ...
    def forward(self, inp: torch.Tensor) -> torch.Tensor:
        ...
        return _LayerNorm.apply(inp, weight, self.bias, self.eps)
